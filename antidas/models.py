...
class Registration(models.Model):
    login = models.CharField(max_length=25, help_text=_('Enter login!'))
    email = models.EmailField(max_length=100, help_text=_('Enter email!'))
    password = models.CharField(max_length=25, help_text=_('Enter password!'))
...
class table_link(models.Model):
    ...
    short_link = models.URLField(help_text=_('Enter Short link!'))
